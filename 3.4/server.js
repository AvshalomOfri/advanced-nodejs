...
class Server extends EventEmitter {
  constructor(client) {
    ...
    process.nextTick(() => {
      //this initial response emitter is wrapped in nextTick because  the server is required by client.js and is fired immediatly before this inital response emitter is defined.
      this.emit(
        "response",
